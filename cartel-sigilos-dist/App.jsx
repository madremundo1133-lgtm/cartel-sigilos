    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center p-4 font-sans selection:bg-amber-500/30">
      ...
      <style>{`
        @media print {
          ...
          .poster-container {
            transform: scale(0.65); /* Escala optimizada para A4 de una página */
            box-shadow: none !important;
            border: none !important;
          }
          /* CLASE MÁGICA: Oculta los botones al imprimir */
          .no-print {
    ...
    <div className="poster-container relative w-full max-w-[480px] bg-stone-900 rounded-sm shadow-2xl border border-amber-500/20 overflow-hidden">
          ...
          <div className="space-y-3">
             <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white text-[10px] leading-relaxed opacity-90">
                    Plataforma profesional de estudio. Acceso estructurado y soporte técnico incluido.
                  </p>
                </div>
             </div>
             ...
             <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white text-[10px] leading-relaxed opacity-90">
                    Recibe una <strong>Tarjeta de Iniciación Digital</strong> al instante. Perfecta para imprimir o enviar como el regalo definitivo este día de Reyes.
                  </p>
                </div>
             </div>
             ...
             <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white text-[10px] leading-relaxed opacity-90">
                    Manuales en PDF, plantillas arcanas y Flashcards de estudio para interiorizar el conocimiento.
                  </p>
                </div>
             </div>
          </div>
      ...
      <div className="relative z-10 px-6 mb-2">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h3 className="text-amber-500 text-xs font-serif uppercase tracking-[0.2em] font-bold">
            Ruta de Iniciación (8 Semanas)
          </h3>
          <Compass size={14} className="text-amber-500" />
        </div>
        ...
        <div className="grid grid-cols-4 gap-2">
          {syllabus.map((item, index) => (
            <div key={index} className="flex flex-col items-center p-2 bg-stone-900 border border-stone-700/50 rounded hover:border-amber-500/40 hover:bg-stone-800 transition-all group shadow-md text-center h-full">
              <div className="text-amber-500 mb-1 group-hover:text-amber-300 group-hover:scale-110 transition-transform duration-300">
                {item.icon}
              </div>
              <h4 className="text-amber-500 text-[9px] font-black uppercase tracking-wider mb-0.5 leading-tight group-hover:text-amber-200 transition-colors">
                {item.title}
              </h4>
              <p className="text-stone-200 text-[8px] font-medium leading-tight group-hover:text-white">
                {item.subtitle}
              </p>
            </div>
          ))}
      ...
      <div className="relative z-10 bg-gradient-to-t from-stone-950 via-stone-900 to-stone-900/80 pt-8 pb-10 px-8 border-t border-amber-500/10">
        ...
        <div className="flex flex-col items-center gap-2 mb-4">
           <div className="flex items-center justify-center space-x-2 bg-gradient-to-r from-red-950 to-stone-900 border border-red-500/50 px-4 py-1.5 rounded-full shadow-[0_0_20px_rgba(153,27,27,0.3)] w-full max-w-[280px]">
              ...
              <span className="text-white text-[8px] font-bold uppercase tracking-widest text-center">
               REGALA CONOCIMIENTO • INICIO FEBRERO
              </span>
              <Star size={10} className="text-amber-400 fill-amber-400 animate-pulse" />
           </div>
           ...
           <div className="flex items-center space-x-2 bg-stone-800/80 border border-amber-500/30 px-4 py-1.5 rounded-full w-full justify-center max-w-[280px]">
              ...
              <span className="text-amber-100 text-[9px] font-bold uppercase tracking-widest">
                INICIACIÓN PRESENCIAL REQUERIDA
              </span>
           </div>
        </div>
        ...
        <div className="text-center mb-2 relative bg-stone-950/50 p-2 rounded border border-stone-800/50">
           ...
           <p className="text-white text-[9px] font-bold uppercase tracking-wider mt-1">
             Cristaliza tu acceso antes del cambio de ciclo
           </p>
        </div>

        <div className="bg-stone-800/60 border border-amber-500/20 rounded p-2 backdrop-blur-sm shadow-lg">
          <p className="text-center text-amber-500 text-[9px] uppercase tracking-[0.2em] font-bold mb-1">
            CANALES DE INSCRIPCIÓN
          </p>
          
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center space-x-2 p-1 rounded hover:bg-white/5 transition-colors cursor-pointer group">
            ...
            <div className="flex items-center space-x-2 p-1 rounded hover:bg-white/5 transition-colors cursor-pointer group">
               ...
               <div className="flex flex-col">
                 ...
                 <span className="text-white text-[10px] font-medium tracking-wide font-sans">cursos@academynexus.com</span>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-stone-900/80 border border-amber-500/30 rounded-sm p-3 mt-4 text-center space-y-2">
          <h4 className="text-amber-500 text-[9px] font-serif uppercase tracking-[0.2em] font-bold">RECIBE EL DOSSIER DEL RITO</h4>
          <p className="text-white text-[9px] leading-relaxed">
            Escanea este código QR y deja tu nombre y correo para recibir en tu email el dossier completo del Rito de los Sigilos.
          </p>
          <img src="/qr-dossier-sigilos.png" alt="QR Dossier Rito de los Sigilos" className="w-24 h-24 mx-auto mt-2 rounded-sm border border-amber-500/50 shadow-[0_0_18px_rgba(245,158,11,0.4)] bg-stone-900" />
        </div>
        ...
        <div className="text-center mt-4 space-y-1">
          ...
          <p className="text-white text-[9px] opacity-100">
            Plazas estrictamente limitadas para asegurar soporte personalizado.
          </p>
        </div>
